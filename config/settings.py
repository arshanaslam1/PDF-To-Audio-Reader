"""
Django settings for PDF_to_Audio_Reader project.
...
SECRET_KEY = 'django-insecure-kwq2)oqxt8q32sy2h0^j!h4_(hth(6%fi4tstdyh(h)5i&kzzq'
...
LOGIN_REDIRECT_URL = 'main:pdf-home'
LOGIN_URL = 'login'
